<header class="">
	<div id="sidebar" class="fixed top-0 left-0 w-64 h-full bg-white shadow-lg transform transition-transform duration-300 md:translate-x-0 -translate-x-full md:static md:flex-shrink-0 z-50 relative">
	    <div class="p-6">

	     	<div class="flex items-center justify-center">
	      		<img class="max-w-[100px]" src="./images/logo.jpg" draggable="false"  alt="">
	      		<h2 class="text-xl font-bold LINE">Primeira <span class="text-2xl  text-blue-800">OPÇÃO</span></h2>
	      	</div>
