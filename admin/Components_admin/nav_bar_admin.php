<header class="">
	<div id="sidebar" class="fixed top-0 left-0 w-64 h-screen bg-white shadow-lg transform transition-transform duration-300 md:translate-x-0 -translate-x-full md:static md:flex-shrink-0 z-50 relative">
	    <div class="p-6">
