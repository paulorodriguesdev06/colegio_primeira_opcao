<?php $this->view('templates/headPublic') ?>
        ...
        <div class="relative">
            <nav id="left-menu" class="flex flex-col fixed left-0 w-60 h-full bg-blue-700 shadow-lg text-gray-100 text-sm p-4 ">
                ...
                <div class="nav-links flex flex-col gap-1">
                    ...
                    <a href="<?= BASE_URL ?>\home" class="nav-link flex gap-2 transition hover:bg-blue-800 p-2 rounded-xl">
                    ...
                    <div class="overflow-hidden max-h-0 opacity-0 transition-all duration-400 ease-in-out ml-4" id="documents-dropdown">
                        ...
                        <a href="<?= BASE_URL ?>\simulados" class="nav-link flex gap-2 items-center p-2 ml-4 transition delay-100 hover:bg-blue-800 rounded-xl dropdown">
                            <i class="fa-regular fa-file-lines text-lg"></i>
                            Simulados
                        </a>
